...
public class CalendarAppTest {
	...
	public void testCalendarEvents(){		
		...
		calOne.addEvent(xmas, calOne.getOwner());
		assertTrue(calOne.hasNext() == true);
		
		calTwo.addEvent(docMuflon, calTwo.getOwner());
		assertTrue(calTwo.hasNext() == true);
		
		calThree.addEvent(birthday, calThree.getOwner());
	...
	public void testTwoEventsStartingAtTheSameDate(){
		...
		calOne.addEvent(xmas, calOne.getOwner());
		calOne.addEvent(birthday, calOne.getOwner());
	...
	public void testAllPublicEvents(){
		...
		calTwo.addEvent(xmas, calTwo.getOwner());
		calTwo.addEvent(birthday, calTwo.getOwner());
		calTwo.addEvent(valentine, calTwo.getOwner());
	...
	public void testAllPrivateEvents(){
		...
		calThree.addEvent(xmas, hamada);
		calThree.addEvent(birthday, hamada);
		calThree.addEvent(dateHamada, hamada);
